...
void main() {
    ...
    // //Patter 28
    // vec2 lightUv = vec2(vUv.x * 0.125 + 0.43, vUv.y);
    // float strength = 0.015 / distance(lightUv, vec2(0.5));

    // //Patter 29
    // vec2 lightUvX = vec2(vUv.x * 0.25 + 0.375, vUv.y);
    // vec2 lightUvY = vec2(vUv.x, vUv.y * 0.25 + 0.375);
    ...
    // vec2 lightUvY = vec2(rotatedUv.x, rotatedUv.y * 0.25 + 0.375);
    // float strength = 0.015 / distance(lightUvX, vec2(0.5));
    // strength *= 0.015 / distance(lightUvY, vec2(0.5));
    ...
    // Patter 49
    float strength = sin(cnoise(vUv * 10.0) * 1.0);
