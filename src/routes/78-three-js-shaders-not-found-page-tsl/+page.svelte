...
<div
	class="absolute left-1/2 top-[77.5%] text-center -translate-y-1/2 -translate-x-1/2 mt-[28px] flex flex-col items-center"
>
	<p class=" text-2xl font-audiowide">Page Not Found</p>
	<div class="flex flex-col items-center mt-3">
		<div
			class="h-[1px] w-full bg-gradient-to-r from-transparent via-white to-transparent"
		></div>
		<button
			id="explore-btn"
			data-auto-click="true"
			class="cursor-pointer w-fit px-3 py-[2px] font-audiowide tracking-[5px]"
			>Go home</button
		>
		<div
			class="h-[1px] w-full bg-gradient-to-r from-transparent via-white to-transparent"
