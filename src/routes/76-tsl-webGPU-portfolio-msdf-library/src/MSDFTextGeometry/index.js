...
export default class MSDFTextGeometry extends BufferGeometry {
	...
	update(options) {
		...
		this.setAttribute(
			'glyphResolution',
			new BufferAttribute(attributes.glyphResolution, 2)
		);
		...
		this.setAttribute(
			'lineLettersTotal',
			new BufferAttribute(infos.lineLettersTotal, 1)
		);
		this.setAttribute(
			'lineLetterIndex',
			new BufferAttribute(infos.lineLetterIndex, 1)
		);

		this.setAttribute(
			'lineWordsTotal',
			new BufferAttribute(infos.lineWordsTotal, 1)
		);
		this.setAttribute(
			'lineWordIndex',
			new BufferAttribute(infos.lineWordIndex, 1)
		);
